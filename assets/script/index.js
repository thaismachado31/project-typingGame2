...
function startGame() {
    ...
    selectWord(fewWords);
    console.log(typeWordInput.value);
}
...
// function checkRound(wordlist) {

//     if (typingGame.round < 8) {
//         selectWord(wordlist.word3Letters)
//     };
//     if (8 >= typingGame.round <= 15) {
//         selectWord(wordlist.word4Letters)
//     };
//     if (16 >= typingGame.round <= 23) {
//         selectWord(wordlist.word5Letters)
//     };
//     if (24 >= typingGame.round <= 31) {
//         selectWord(wordlist.word6Letters)
//     };
//     if (32 >= typingGame.round <= 39) {
//         selectWord(wordlist.word7Letters)
//     };
//     if (40 >= typingGame.round <= 47) {
//         selectWord(wordlist.word8Letters)
//     };
//     if (48 >= typingGame.round <= 55) {
//         selectWord(wordlist.word9Letters)
//     };
//     if (typingGame.round > 55) {
//         selectWord(wordlist.word10Letters)
//     }; 
// }
...
//     };
//     if (8 >= typingGame.round <= 15) {
//         selectWord(allWords[1])
//     };
//     if (16 >= typingGame.round <= 23) {
//         selectWord(allWords[2])
//     };
//     if (24 >= typingGame.round <= 31) {
//         selectWord(allWords[3])
//     };
//     if (32 >= typingGame.round <= 39) {
//         selectWord(allWords[4])
//     };
//     if (40 >= typingGame.round <= 47) {
//         selectWord(allWords[5])
//     };
//     if (48 >= typingGame.round <= 55) {
//         selectWord(allWords[6])
//     };
//     if (typingGame.round > 55) {
//         selectWord(allWords[7])
//     }; 
// }

// function selectWordList(wordList) {
//     let letterWords = 0
//     if (typingGame.round % 8 === 0 && letterWords <= 7) {
//         letterWords++
//         const chooseList = Object.keys(wordList)[letterWords]
//         selectWord(wordList.chooseList)
//     }
// }
